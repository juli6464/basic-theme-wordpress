...
function init_template(){
    ...
    add_theme_support( 'title-tag'); //title-tag es titulo en navegador 
...
function assets(){
    ...
    //prueba llamando custom.js verificando que tome el msj de hola wordpress
    wp_enqueue_script( 'custom',get_template_directory_uri().'/assets/js/custom.js','','1.0',true);
 
}    
 
// Para que se cargue  al inicio de la página
